...
export default function Form() {
  ...
  return (
    <form
      ...
      className="flex flex-col m-10 text-xl items-center"
    >
      <div className="flex flex-col bg-gray-200 p-20 rounded-2xl">
        ...
        <span>
          <label className="mr-20">City :</label>
          <input
            value={form.city}
            name="city"
            onChange={handleChange}
        ...
        <span>
          <label className="mr-20">Contact :</label>
          <input
            value={form.contact}
            name="contact"
            onChange={handleChange}
        ...
        <span>
          <label className="mr-20">Gender :</label>
          <input
            value={form.gender}
            name="gender"
            onChange={handleChange}
